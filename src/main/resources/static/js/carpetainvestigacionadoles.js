...
$(function () {
    ...
    $("#hddTipoCarpetaConsulta").val(11);
    $("#txtTipoCarpetaConsulta").val("Carpeta de Investigacion Adoles");
    $("#hddTipoCarpetaRegistro").val(11);
    $("#txtTipoCarpetaRegistro").val("Carpeta de Investigacion Adoles");
