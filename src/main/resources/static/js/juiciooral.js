        ...
        .autocomplete(
                {
                    source: function (request, response) {
                        ...
                        tipoConclusion.idTipoCarpeta = 2;
...
$(function () {
    ...
    $("#hddTipoCarpetaConsulta").val(2);
    $("#txtTipoCarpetaConsulta").val("CAUSA DE JUICIO ORAL");
    $("#hddTipoCarpetaRegistro").val(2);
    $("#txtTipoCarpetaRegistro").val("CAUSA DE JUICIO ORAL");
