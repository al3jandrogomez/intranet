...
$(function () {
    ...
    $("#hddTipoCarpetaConsulta").val(10);
    $("#txtTipoCarpetaConsulta").val("Tocas Penales Adoles");
    $("#hddTipoCarpetaRegistro").val(10);
    $("#txtTipoCarpetaRegistro").val("Tocas Penales Adoles");
