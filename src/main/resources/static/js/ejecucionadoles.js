        ...
        .autocomplete(
                {
                    source: function (request, response) {
                        ...
                        tipoConclusion.idTipoCarpeta = 3;
...
guardarAudiencia = function () {
    ...
    var fechaAceptacion = cambiarfecha($("#txtFechaAceptacion").val());
    var fechaAmonestacion = cambiarfecha($("#txtFechaAmonestacion").val());
    var fechaActividades = cambiarfecha($("#txtFechaActividades").val());
    var fechaSancion = cambiarfecha($("#txtFechaSancion").val());
    ...
    audiencia.fechaAceptacion = fechaAceptacion;
    audiencia.fechaAmonestacion = fechaAmonestacion;
    audiencia.fechaActividades = fechaActividades;
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(response, function (index, element) {
                ...
                $("#txtFechaAceptacion").val(cambiarFecha2(element.fechaAceptacion));
                $("#txtFechaAmonestacion").val(cambiarFecha2(element.fechaAmonestacion));
                $("#txtFechaActividades").val(cambiarFecha2(element.fechaActividades));
                $("#txtFechaSancion").val(cambiarFecha2(element.fechaSancion));
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(response, function (index, element) {
                ...
                table += "<tr>" +
                        "<th scope=\"row\">" + (index + 1) + "</th>" +
                        "<td>" + element.tipoAudiencia.descTipoAudiencia + "</td>" +
                        "<td>" + element.fechaAudiencia + "</td>" +
                        "<td></td>" +
                        "<td>&nbsp;</td>" +
                        "<td>&nbsp;</td>" +
                        "<td>" + button + "</td>" +
...
limpiarActuacion = function () {
    ...
    $("#txtFechaAmonestacion").val("");
    $("#txtFechaActividades").val("");
    $("#txtFechaSancion").val("");
    $("#txtTipoAudiencia").val("");
    ...
    $("#txtFechaAceptacion").prop("disabled", true);
    $("#txtFechaAmonestacion").prop("disabled", true);
    $("#txtFechaActividades").prop("disabled", true);
    $("#txtFechaSancion").prop("disabled", true);
...
nuevaAudiencia = function () {
    ...
    $("#txtFechaAceptacion").prop("disabled", false);
    $("#txtFechaAmonestacion").prop("disabled", false);
    $("#txtFechaActividades").prop("disabled", false);
    $("#txtFechaSancion").prop("disabled", false);
...
$(function () {
    ...
    $("#hddTipoCarpetaConsulta").val(13);
    $("#txtTipoCarpetaConsulta").val("EXP. DE EJECUCIÓN DE SENTENCIAS ADOLES");
    $("#hddTipoCarpetaRegistro").val(13);
    $("#txtTipoCarpetaRegistro").val("EXP. DE EJECUCIÓN DE SENTENCIAS ADOLES");
