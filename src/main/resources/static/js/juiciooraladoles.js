        ...
        .autocomplete(
                {
                    source: function (request, response) {
                        ...
                        tipoConclusion.idTipoCarpeta = 12;
...
guardarAudiencia = function () {
    ...
    var fechaDebate = cambiarfecha($("#txtFechaDebate").val());
    var fechaAlegato = cambiarfecha($("#txtFechaAlegatoApertura").val());
    var fechaContinuacion = cambiarfecha($("#txtFechaContinuación").val());
    var fechaPruebaNueva = cambiarfecha($("#txtFechaPruebaNueva").val());
    var fechaAlegatoCierre = cambiarfecha($("#txtFechaAlegatoClausura").val());
    var fechaFallo = cambiarfecha($("#txtFechaEmisionFallo").val());
    var fechaSancion = cambiarfecha($("#txtFechaIndiSanciones").val());
    var fechaLecturaSentencia = cambiarfecha($("#txtFechaExplicacionSen").val());
    ...
    audiencia.fechaDebate = fechaDebate;
    audiencia.fechaAlegato = fechaAlegato;
    audiencia.fechaContinuacion = fechaContinuacion;
    audiencia.fechaPruebaNueva = fechaPruebaNueva;
    audiencia.fechaAlegatoCierre = fechaAlegatoCierre;
    audiencia.fechaFallo = fechaFallo;
    audiencia.fechaSancion = fechaSancion;
    audiencia.fechaLecturaSentencia = fechaLecturaSentencia;
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(response, function (index, element) {
                ...
                $("#txtFechaDebate").val(cambiarFecha2(element.fechaDebate));
                $("#txtFechaAlegatoApertura").val(cambiarFecha2(element.fechaAlegato));
                $("#txtFechaContinuación").val(cambiarFecha2(element.fechaContinuacion));
                $("#txtFechaPruebaNueva").val(cambiarFecha2(element.fechaPruebaNueva));
                $("#txtFechaAlegatoClausura").val(cambiarFecha2(element.fechaAlegatoCierre));
                $("#txtFechaEmisionFallo").val(cambiarFecha2(element.fechaFallo));
                $("#txtFechaIndiSanciones").val(cambiarFecha2(element.fechaSancion));
                $("#txtFechaExplicacionSen").val(cambiarFecha2(element.fechaLecturaSentencia));
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var table = "<table class=\"table table-striped\">" +
                    ...
                    "<th scope=\"col\"><input type='button' class='step-button' onclick='nuevaAudiencia()' value='Nueva Actuación'></th>" +
                    "<th scope=\"col\">&nbsp;</th>" +
                    " </tr>" +
                    "</thead><tbody>";
...
limpiarActuacion = function () {
    ...
    $("#txtFechaDebate").val("");
    $("#txtFechaAlegatoApertura").val("");
    $("#txtFechaContinuación").val("");
    $("#txtFechaPruebaNueva").val("");
    $("#txtFechaAlegatoClausura").val("");
    $("#txtFechaEmisionFallo").val("");
    $("#txtFechaIndiSanciones").val("");
    $("#txtFechaExplicacionSen").val("");

    $("#txtFechaRadicacion").prop("disabled", true);
    $("#txtFechaDebate").prop("disabled", true);
    $("#txtFechaAlegatoApertura").prop("disabled", true);
    $("#txtFechaContinuación").prop("disabled", true);
    $("#txtFechaPruebaNueva").prop("disabled", true);
    $("#txtFechaAlegatoClausura").prop("disabled", true);
    $("#txtFechaEmisionFallo").prop("disabled", true);
    $("#txtFechaIndiSanciones").prop("disabled", true);
    $("#txtFechaExplicacionSen").prop("disabled", true);
...
nuevaAudiencia = function () {
    ...
    $("#txtFechaDebate").prop("disabled", false);
    $("#txtFechaAlegatoApertura").prop("disabled", false);
    $("#txtFechaContinuación").prop("disabled", false);
    $("#txtFechaPruebaNueva").prop("disabled", false);
    $("#txtFechaAlegatoClausura").prop("disabled", false);
    $("#txtFechaEmisionFallo").prop("disabled", false);
    $("#txtFechaIndiSanciones").prop("disabled", false);
    $("#txtFechaExplicacionSen").prop("disabled", false);
...
$(function () {
    ...
    $("#hddTipoCarpetaConsulta").val(12);
    $("#txtTipoCarpetaConsulta").val("CAUSA DE JUICIO ORAL ADOLES");
    $("#hddTipoCarpetaRegistro").val(12);
    $("#txtTipoCarpetaRegistro").val("CAUSA DE JUICIO ORAL ADOLES");
