...
//
//
//                    var button = "<button type=\"button\" class=\"btn btn-primary\" onclick=\"actualizarCarpeta(" + element.id + ");\">Actualizar</button>";
...
guardarCarpeta = function () {
    ...
    var tipoCarpeta = $("#hddTipoCarpetaRegistro").val() == "0" ? null : $("#hddTipoCarpetaRegistro").val();
    ...
    carpeta.idTipoCarpeta = tipoCarpeta;

    tiposCarpeta.idTipoCarpeta = tipoCarpeta;
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var table = "<table class=\"table table-striped\">" +
                    ...
                    "<th scope=\"col\">NUC</th>" +
                    "<th scope=\"col\"><button class='step-button' onclick='nuevoRepresentado()'>Nuevo Representado</button></th>" +
                    "<th scope=\"col\">&nbsp;</th>" +
                    " </tr>" +
                    "</thead><tbody>";
        ...
        .autocomplete(
                {
                    source: function (request, response) {
                        ...
                        tipoConclusion.idTipoCarpeta = 6;
...
$(function () {
    ...
    $("#hddTipoCarpetaConsulta").val(6);
    $("#txtTipoCarpetaConsulta").val("Primera Instancia");
    $("#hddTipoCarpetaRegistro").val(6);
    $("#txtTipoCarpetaRegistro").val("Primera Instancia");
