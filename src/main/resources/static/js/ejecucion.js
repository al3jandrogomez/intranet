...
$(function () {
    ...
    $("#hddTipoCarpetaConsulta").val(3);
    $("#txtTipoCarpetaConsulta").val("EXPEDIENTE DE EJECUCIÓN DE SENTENCIAS");
    $("#hddTipoCarpetaRegistro").val(3);
    $("#txtTipoCarpetaRegistro").val("EXPEDIENTE DE EJECUCIÓN DE SENTENCIAS");
