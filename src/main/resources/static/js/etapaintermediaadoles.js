...
agregarMedidas = function (medida) {
    ...
    var encontrado = false;
    var tamaño = listaMedidas.length;
    ...
    if (tamaño !== listaMedidas.length && tamaño > 0) {
        listarMedidas();
    }
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var table = "<table class=\"table table-striped\">" +
                    ...
                    "<th scope=\"col\">NUC</th>" +
                    "<th scope=\"col\"><input type='button' class='step-button' onclick='nuevoRepresentado()' value='Nuevo Representado'/>" +
                    "<th scope=\"col\">&nbsp;</th>" +
                    " </tr>" +
                    "</thead><tbody>";
...
guardarAudiencia = function () {
    ...
    var fechaAcusacion = cambiarfecha($("#txtFechaIfechaacusacion").val());
    var fechaDescubrimiento = cambiarfecha($("#txtFechaDescubrimiento").val());
    var fechaIntermedia = cambiarfecha($("#txtFechaIntermedia").val());
    var fechaApertura = cambiarfecha($("#txtFechaAudienciaApertura").val());
...
//    var fechaFinInves = cambiarfecha($("#txtFechaFinInvest").val());
    ...
    audiencia.fechaAcusacion = fechaAcusacion;
    audiencia.fechaDescubrimiento = fechaDescubrimiento;
    audiencia.fechaIntermedia = fechaIntermedia;
    audiencia.fechaApertura = fechaApertura;
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(response, function (index, element) {
                ...
                $("#txtFechaIfechaacusacion").val(cambiarFecha2(element.fechaAcusacion));
                $("#txtFechaDescubrimiento").val(cambiarFecha2(element.fechaDescubrimiento));
                $("#txtFechaIntermedia").val(cambiarFecha2(element.fechaIntermedia));
                $("#txtFechaAudienciaApertura").val(cambiarFecha2(element.fechaApertura));
        ...
        success: function (response) {
            ...
            $.each(response, function (index, element) {
                ...
                table += "<tr>" +
                        ...
                        "</tr>";
                table += "<tr>" +
                        "<td colspan='2'><input type='text' class='autocompletar repMedidas' id='representadosAud" + element.representado.idRepresentado + "' disabled></td>" +
                        "</tr>";
                table += "<tr>" +
...
limpiarActuacion = function () {
    ...
    $("#txtFechaIfechaacusacion").val("");
    $("#txtFechaDescubrimiento").val("");
    $("#txtFechaIntermedia").val("");
    $("#txtFechaAudienciaApertura").val("");
    $("#txtFechaIfechaacusacion").prop("disabled", true);
    $("#txtFechaDescubrimiento").prop("disabled", true);
    $("#txtFechaIntermedia").prop("disabled", true);
    $("#txtFechaAudienciaApertura").prop("disabled", true);
...
nuevaAudiencia = function () {
    ...
    $("#txtFechaIntermedia").val("");
    $("#txtFechaAudienciaApertura").val("");
    $("#txtFechaIfechaacusacion").prop("disabled", false);
    $("#txtFechaDescubrimiento").prop("disabled", false);
    $("#txtFechaIntermedia").prop("disabled", false);
    $("#txtFechaAudienciaApertura").prop("disabled", false);
...
$(function () {
    ...
    $("#hddTipoCarpetaConsulta").val(9);
    $("#txtTipoCarpetaConsulta").val("CARPETA ADMINISTRATIVA ADOLES");
    $("#hddTipoCarpetaRegistro").val(9);
    $("#txtTipoCarpetaRegistro").val("CARPETA ADMINISTRATIVA ADOLES");
