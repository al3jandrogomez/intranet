...
<div class="form-group row">
	<h1>Vales para Almac&eacute;n</h1>
...
<div id="frmRequisiciones" style="display: none">
	...
	<div class="  form-group row btn-toolbar col-10">
		...
		<button type="button" class="btn btn-warning btn-sm btn-space"
			onClick="buscarVales()">Salir</button>
	</div>
	<div class="dropdown-divider"></div>
...
<div id="ListaRequisiciones" style="display: block">
	...
	<div class="  form-group row btn-toolbar col-10">
		<button type="button" class="btn btn-primary btn-sm btn-space"
			id="guardarRequisicion">Nuevo Vale</button>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary"
					onclick="guardarVales();">Generar Nueva Solicitud</button>
			</div>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
				<button type="button" class="btn btn-primary"
					onclick="eliminarVales();">Eliminar Solicitud</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">¿Esta seguro que quiere enviar el vale?</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
				<button type="button" class="btn btn-primary"
					onclick="enviarVales();">Si</button>
			</div>
		</div>
	</div>
</div>
...
<script>
	...
	enviarVales = function(idRequisicion) {
	...
	eliminarVales = function(idRequisicion) {
		idRequisicion = idRequisicion == null ? $("#hddIdRequisiciones").val()
				: idRequisicion;
		dRequisicion = new Requisicion(idRequisicion, null, 2, null);
		dRequisicion = JSON.stringify(dRequisicion);
