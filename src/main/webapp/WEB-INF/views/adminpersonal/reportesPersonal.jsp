...
<div id="frmMateriaPenal">
    ...
    <div class="  form-group row btn-toolbar col-10">
        ...
        <button type="button" class="btn btn-warning btn-sm btn-space" onClick="generarReporte()">Generar Reporte</button>
