...
<div class="form-group row">
    <h1>Intervenciones turnadas a perito</h1>
...
<div id="frmRequisiciones" style="display: none">
    ...
    <div class="  form-group row btn-toolbar col-10">
        ...
        <button type="button" class="btn btn-primary btn-sm btn-space"
                id="enviarRequisicion">Terminar intervención</button>
        <button type="button" class="btn btn-danger btn-space eliminar">Guardar Avance</button>
    ...
    <div id="adsSolicitante">
        <div class="col-4">
            <input class="form-control numero" type="text" value=""
                   id="txtNumero" placeholder="Descripcion de la intervención">
        </div>
        <div class="col-4">
             <label for="example-search-input" class="col-10 col-form-label">adjuntar documentos</label>
...
<div id="ListaRequisiciones" style="display: block">
    ...
    <div class="  form-group row btn-toolbar col-10">
        <div class="col-4">
            <input class="form-control numero" type="text" value=""
                   id="txtNumero" placeholder="Numero de la solicitud">
        </div>
        <div class="col-4">
            <input class="form-control numero" type="text" value="" id="txtAnio"
                   placeholder="Año de la solcitud">
        </div>
        <div class="col-2">
            <button type="button" class="btn btn-warning btn-sm btn-space"
