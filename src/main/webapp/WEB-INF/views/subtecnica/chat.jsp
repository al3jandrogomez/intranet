...
<style>
    * {
    ...
    <div id="chat" >
        ...
        <div class="listaChat">
            <img class="chat" src="resources/images/chat3.jpeg" onclick="cargarFrmRepresentado()">

        </div>

        <div class="modal fade" id="myModalRepresentado" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                            ...
                            <div class="username-page-container">
                                ...
                                <form id="usernameForm" name="usernameForm">
                                    <div class="form-group">
                                        <input type="text" id="nombre" placeholder="Nombre" autocomplete="off" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" id="paterno" placeholder="Apellido Paterno" autocomplete="off" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" id="materno" placeholder="Apellido Materno" autocomplete="off" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" id="txtMunicipio"  placeholder="Municipio" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button id ="ingresar-chat" type="button" class="accent username-submit">Ingresar al chat</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="location.reload(true);">Cerrar</button>
...
$(function(){
    ...
    <script src="resources/js/chat/chat_usuario.js"></script>
