...
<input type="hidden" id="hddTipoCarpetaConsulta"  value = "5"/>
<input type="hidden" id="hddJuzgadoRegistro" value="0"/>
<input type="hidden" id="hddTipoCarpetaRegistro"  value = "5"/>
...
<input type="hidden" id="rutaFormulario"  value = "estadistica/capturasalaspe"/>



<link rel="stylesheet" href="resources/css/controloral.css">
<div class="icon-bar" id = "barrras">
    <a href="#"  id = "barra1" class=" barra barra1 active"><i class="fa1">Consulta de Tocas Penales</i></a>
    <a href="#"  id = "barra2" class=" barra barra2"><i class="fa2">Registro de Tocas Penales</i></a>
    ...
    <div class=" root busquedacarpeta  carpeta active">
        <form class="form-register1">
            <div class="form-register-header"> 
                <h1 class="form-register-title">Consulta de Tocas Penales</h1>
            </div>
            <div class="form-register-body"> 
                <div class="step active " >
                    <div class="step-header">
                        <h2 class="step-title">Informaci&oacute;n de Tocas Penales</h2>
                    </div>
                    <div class="step-body">
            ...
            <div class="form-register-body"> 
                ...
                <div class="step" id="step-3">
                    ...
                    <div class="step-body">
                        ...
                        <input type="text" id= "txtFechaAudiencia" placeholder="Fecha Actuacion" class="step-input datepicker">
                        <input type="text" id= "txtFechaRadicacion" placeholder="Fecha de Radicacion" class="step-input datepicker">
                        <input type="text" id= "txtFechaResolver" placeholder="Fecha para Resolver  sobre Recurso de Apelación" class="step-input datepicker">

                        <input type="text"  placeholder="Tipo de Actuación" class="step-input" id = "txtTipoAudiencia">
                        <input type="text"  placeholder="Resolución" class="step-input" id="txtTipoconclusiones">
...
<script src="resources/js/salaspenales.js"/>
