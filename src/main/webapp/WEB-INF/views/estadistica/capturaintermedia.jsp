...
<input type="hidden" id="rutaFormulario"  value = "estadistica/capturaintermedia"/>



<link rel="stylesheet" href="resources/css/controloral.css">
<div class="icon-bar" id = "barrras">
    <a href="#"  id = "barra1" class=" barra barra1 active"><i class="fa1">Consulta de Carpetas Intermedia</i></a>
    <a href="#"  id = "barra2" class=" barra barra2"><i class="fa2">Registro de Carpetas Intermedia</i></a>
...
<script src="resources/js/etapaintermedia.js"/>
