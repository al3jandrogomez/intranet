...
<input type="hidden" id="rutaFormulario"  value = "estadistica/capturacarpeta"/>



<link rel="stylesheet" href="resources/css/controloral.css">
<div class="icon-bar" id = "barrras">
    <a href="#"  id = "barra1" class=" barra barra1 active"><i class="fa1">Consulta de Carpeta Investigación</i></a>
    <a href="#"  id = "barra2" class=" barra barra2"><i class="fa2">Registro de Carpeta Investigación</i></a>
...
<div class="opciones">
    ...
    <div class=" root busquedacarpeta  carpeta active">
        <form class="form-register1 busqueda" >
            <div class="form-register-header"> 
                <h1 class="form-register-title">Consulta de Carpeta Investigación</h1>
            </div>
            <div class="form-register-body"> 
                <div class="step active " >
                    <div class="step-header">
                        <h2 class="step-title">Informaci&oacute;n de Carpeta Investigación </h2>
                    </div>
                    <div class="step-body">
                         <input type="text" placeholder="N&uacute;mero Unico de Causa(NUC)" id="txtNucConsulta" class="step-input">
                        <input type="text" placeholder="Agencia M.P." id="txtJuzgadoConsulta"class="step-input">
        ...
        <form class="form-register">
            <div class="form-register-header"> 
                <ul class="progressbar">
                    <li class="progressbar-option active">Registro  de Carpetas de Investigación </li>
            ...
            <div class="form-register-body"> 
                <div class="step active " id="step-1">
                    <div class="step-header">
                        <h2 class="step-title">Informaci&oacute;n  de Carpetas de Investigación </h2>
                    </div>
                    <div class="step-body">
                        <input type="text" placeholder="N&uacute;mero Unico de Carpeta (NUC)" id="txtNucRegistro" class="step-input">
                        <input type="text" placeholder="Agencia M.P." id="txtJuzgadoConsultaRegistro"class="step-input">
                ...
                <div class="step" id="step-3">
                    ...
                    <div class="step-body">
                        ...
                        <input type="text" id= "txtFechaAcuerdoRetencion" placeholder="Fecha de Acuerdo de Retención" class="step-input datepicker">
                        <input type="text" id= "txtFechaProximaCita" placeholder="Fecha Proxima Cita" class="step-input datepicker">
                        <input type="text" id= "txtFechaProximaAudiencia" placeholder="Fecha Proxima Actuación" class="step-input datepicker">
...
<script src="resources/js/carpetainvestigacion.js"/>
