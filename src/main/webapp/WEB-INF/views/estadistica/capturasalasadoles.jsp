...
<input type="hidden" id="rutaFormulario"  value = "estadistica/capturasalasadoles"/>



<link rel="stylesheet" href="resources/css/controloral.css">
<div class="icon-bar" id = "barrras">
    <a href="#"  id = "barra1" class=" barra barra1 active"><i class="fa1">Consulta de Tocas Adolescentes</i></a>
    <a href="#"  id = "barra2" class=" barra barra2"><i class="fa2">Registro de Tocas Adolescentes</i></a>
    ...
    <div class=" root busquedacarpeta  carpeta active">
        <form class="form-register1">
            <div class="form-register-header"> 
                <h1 class="form-register-title">Consulta de Tocas Adolescentes</h1>
            </div>
            <div class="form-register-body"> 
                <div class="step active " >
                    <div class="step-header">
                        <h2 class="step-title">Informaci&oacute;n de Tocas Adolescentes </h2>
                    </div>
                    <div class="step-body">
...
<script src="resources/js/salasadolescentes.js"/>
