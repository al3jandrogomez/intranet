...
<input type="hidden" id="rutaFormulario"  value = "estadistica/capturacontrol"/>
...
<div class="icon-bar" id = "barrras">
    <a href="#"  id = "barra1" class=" barra barra1 active"><i class="fa1">Consulta de Carpetas Administrativas</i></a>
    <a href="#"  id = "barra2" class=" barra barra2"><i class="fa2">Registro de Carpetas Administrativas</i></a>
    ...
    <div class=" root busquedacarpeta  carpeta active">
        <form class="form-register1">
            <div class="form-register-header"> 
                <h1 class="form-register-title">Consulta de Carpetas Administrativas</h1>
            </div>
            <div class="form-register-body"> 
                <div class="step active " >
                    <div class="step-header">
                        <h2 class="step-title">Informaci&oacute;n de Carpetas Administrativas</h2>
                    </div>
                    <div class="step-body">
        ...
        <form class="form-register">
            ...
            <div class="form-register-body"> 
                ...
                <div class="step" id="step-2">
                    ...
                    <div class="step-footer">
                        <button type="button" id ="btnRegresarRepr" class="step-button step-button-back" data-to_step="1" data-step="2" onclick="cambiarPasos(this,true)"
 >Regresar</button>
                ...
                <div class="step" id="step-3">
                    ...
                    <div class="step-footer">
                        <button type="button" class="step-button step-button-back" data-to_step="2" data-step="3" onclick="consultarImputados();onclick="cambiarPasos(this,true)"
;">Regresar</button>
...
<script src="resources/js/controloral.js"/>
