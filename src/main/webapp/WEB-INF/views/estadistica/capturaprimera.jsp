...
<input type="hidden" id="rutaFormulario"  value = "estadistica/capturaprimera"/>



<link rel="stylesheet" href="resources/css/controloral.css">
<div class="icon-bar" id = "barrras">
    <a href="#"  id = "barra1" class=" barra barra1 active"><i class="fa1">Consulta de Expedientes Primera Instancia</i></a>
    <a href="#"  id = "barra2" class=" barra barra2"><i class="fa2">Registro de Expedientes Primera Instancia</i></a>
...
<script src="resources/js/primerainstancia.js"/>
