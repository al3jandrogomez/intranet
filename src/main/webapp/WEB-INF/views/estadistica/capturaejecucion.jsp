...
<input type="hidden" id="rutaFormulario"  value = "estadistica/capturaejecucion"/>
            ...
            <div class="form-register-body"> 
                ...
                <div class="step" id="step-3">
                    ...
                    <div class="step-body">
                        ...
                        <input type="text" id= "txtFechaRadicacion" placeholder="Fecha de Radicación de Expediente" class="step-input datepicker">
                        <input type="text" id= "txtFechaAceptacion" placeholder="Fecha de Aceptación del Cargo" class="step-input datepicker">
                        <input type="text" id= "txtFechaAmonestacion" placeholder="Fecha Audiencia de Amonestación" class="step-input datepicker">
                        <input type="text" id= "txtFechaActividades" placeholder="Fecha Revisión de Plan de Actividades" class="step-input datepicker">
                        <input type="text" id= "txtFechaSancion" placeholder="Fecha de Sanción" class="step-input datepicker">
...
<script src="resources/js/ejecucion.js"/>
