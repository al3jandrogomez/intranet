...
<div id="frmMateriaPenal">
    ...
    <div class="valida" id="botones" style="display: block"><input type='button' class="btn btn-success"
            value="Autorizar" onclick="autorizar()" /><input type='button' class="btn btn-danger" value="Rechazar"
            onclick="rechazar()" /><input type='button' class="btn btn-warning" value="Regresar a la lista"
            onclick="regresarlista()"></div>
    ...
    <script>
        ...
        listaEntregaInformes = function () {
            ...
            var operacion = "listaentregainformespenales";
           /* if (cveUsuario > 0) {
                        ...
                        $
                            .each(
                                ...
                                function (index, element) {
                                    ...
                                    if (estatus === "C")
                                        descripcion = "En proceso de validaci&oacute;n del coordinador";
                                    else if (estatus === "E")
