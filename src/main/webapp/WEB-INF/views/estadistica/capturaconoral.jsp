...
<input type="hidden" id="hddTipoCarpetaConsulta"  value = "0"/>
<input type="hidden" id="hddJuzgadoRegistro" value="0"/>
<input type="hidden" id="hddTipoCarpetaRegistro"  value = "0"/>
...
<input type="hidden" id="rutaFormulario"  value = "estadistica/capturaconoral"/>



<link rel="stylesheet" href="resources/css/controloral.css">
<div class="icon-bar" id = "barrras">
    <a href="#"  id = "barra1" class=" barra barra1 active"><i class="fa1">Consulta de Carpetas</i></a>
    <a href="#"  id = "barra2" class=" barra barra2"><i class="fa2">Registro de Carpetas</i></a>
...
<script src="resources/js/juiciooral.js"/>
