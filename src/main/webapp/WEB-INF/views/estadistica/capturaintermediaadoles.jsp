...
<input type="hidden" id="rutaFormulario"  value = "estadistica/capturaintermediaadoles"/>



<link rel="stylesheet" href="resources/css/controloral.css">
<div class="icon-bar" id = "barrras">
    <a href="#"  id = "barra1" class=" barra barra1 active"><i class="fa1">Consulta de Carpetas Intermedia Adoles</i></a>
    <a href="#"  id = "barra2" class=" barra barra2"><i class="fa2">Registro de Carpetas Intermedia Adoles</i></a>
    ...
    <div class=" root busquedacarpeta  carpeta active">
        <form class="form-register1">
            <div class="form-register-header"> 
                <h1 class="form-register-title">Consulta de Expedientes</h1>
            </div>
            <div class="form-register-body"> 
                <div class="step active " >
                    ...
                    <div class="step-body">
                        <input type="text" placeholder="Numero del Carpeta" id = "txtNumeroExpConsulta" class="step-input">
                        <input type="text" placeholder="A&ntilde;o del Carpeta" id = "txtAnioExpConsulta" class="step-input">
        ...
        <form class="form-register">
            ...
            <div class="form-register-body"> 
                <div class="step active " id="step-1">
                    ...
                    <div class="step-body">
                        <input type="text" placeholder="Numero del Carpeta" id="txtNumeroExpRegistro" class="step-input">
                        <input type="text" placeholder="A&ntilde;o del Carpeta" id="txtAnioExpRegistro" class="step-input">
                        <input type="text" placeholder="Juzgado" class="step-input" id="txtJuzgadoConsultaRegistro" disabled="disabled">
                ...
                <div class="step" id="step-3">
                    ...
                    <div class="step-body">
                        ...
                        <input type="text" id= "txtFechaIfechaacusacion" placeholder="Fecha de acusación" class="step-input datepicker">
                        <input type="text" id= "txtFechaDescubrimiento" placeholder="Fecha Descubrimiento Probatorio" class="step-input datepicker">
                         <input type="text" id= "txtFechaIntermedia" placeholder="Fecha Audiencia -intermedia" class="step-input datepicker">
                         <input type="text" id= "txtFechaAudienciaApertura" placeholder="Fecha Auto de Apertura a Juicio Oral" class="step-input datepicker">
...
<script src="resources/js/etapaintermediaadoles.js"/>
