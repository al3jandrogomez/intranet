...
<input type="hidden" id="hddTipoCarpetaConsulta"  value = "12"/>
<input type="hidden" id="hddJuzgadoRegistro" value="0"/>
<input type="hidden" id="hddTipoCarpetaRegistro"  value = "12"/>
...
<input type="hidden" id="rutaFormulario"  value = "estadistica/capturaconoraladoles"/>



<link rel="stylesheet" href="resources/css/controloral.css">
<div class="icon-bar" id = "barrras">
    <a href="#"  id = "barra1" class=" barra barra1 active"><i class="fa1">Consulta de Causas Adoles</i></a>
    <a href="#"  id = "barra2" class=" barra barra2"><i class="fa2">Registro de Carpetas Adoles</i></a>
    ...
    <div class=" root busquedacarpeta  carpeta active">
        <form class="form-register1">
            <div class="form-register-header"> 
                <h1 class="form-register-title">Consulta de la Causa</h1>
            </div>
            <div class="form-register-body"> 
                <div class="step active " >
                    <div class="step-header">
                        <h2 class="step-title">Informaci&oacute;n de la Causa </h2>
                    </div>
                    <div class="step-body">
                        <input type="text" placeholder="Numero del Causa" id = "txtNumeroExpConsulta" class="step-input">
                        <input type="text" placeholder="A&ntilde;o del Causa" id = "txtAnioExpConsulta" class="step-input">
        ...
        <form class="form-register">
            <div class="form-register-header"> 
                <ul class="progressbar">
                    <li class="progressbar-option active">Registro de Causas</li>
                    <li class="progressbar-option ">Registro de Representados</li>
                    <li class="progressbar-option ">Registro Actuaciones</li>
                </ul>
                <h1 class="form-register-title">Registro de Causas</h1>

            </div>
            <div class="form-register-body"> 
                <div class="step active " id="step-1">
                    <div class="step-header">
                        <h2 class="step-title">Informaci&oacute;n del Causas </h2>
                    </div>
                    <div class="step-body">
                        <input type="text" placeholder="Numero del Causa" id="txtNumeroExpRegistro" class="step-input">
                        <input type="text" placeholder="A&ntilde;o del Causa" id="txtAnioExpRegistro" class="step-input">
                ...
                <div class="step" id="step-3">
                    ...
                    <div class="step-body">
                          <input type="text" id= "txtFechaAudiencia" placeholder="Fecha de la Actuación" class="step-input datepicker">
                        <input type="text" id= "txtFechaRadicacion" placeholder="Fecha de Radicación" class="step-input datepicker">
                         <input type="text" id= "txtFechaDebate" placeholder="Fecha de audiencia de Debate" class="step-input datepicker">
                        <input type="text" id= "txtFechaAlegatoApertura" placeholder="Fecha Alegato de Apertura" class="step-input datepicker">
                        <input type="text" id= "txtFechaContinuación" placeholder="Fecha Continuación de Juicio" class="step-input datepicker">
                        <input type="text" id= "txtFechaPruebaNueva" placeholder="Fecha Prueba Nueva o de Refutación" class="step-input datepicker">
                       
                        <input type="text" id= "txtFechaAlegatoClausura" placeholder="Fecha Alegato de Clausura" class="step-input datepicker">
                         <input type="text" id= "txtFechaEmisionFallo" placeholder="Fecha de Emisión de Fallo" class="step-input datepicker">
                         
                          <input type="text" id= "txtFechaIndiSanciones" placeholder="Fecha  de Individualización de Sanciones" class="step-input datepicker">
                           <input type="text" id= "txtFechaExplicacionSen" placeholder="Fecha  Lectura y Explicacion Sentencia " class="step-input datepicker">
                        
                           
                        <input type="text"  placeholder="Tipo de Audiencia" class="step-input" id = "txtTipoAudiencia">
                        <input type="text"  placeholder="Determinación" class="step-input" id="txtTipoconclusiones">
...
<script src="resources/js/juiciooraladoles.js"/>
