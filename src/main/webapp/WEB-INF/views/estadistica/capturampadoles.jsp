...
<input type="hidden" id="hddTipoCarpetaConsulta"  value = "11"/>
<input type="hidden" id="hddJuzgadoRegistro" value="0"/>
<input type="hidden" id="hddTipoCarpetaRegistro"  value = "11"/>
            ...
            <div class="form-register-body"> 
                <div class="step active " id="step-1">
                    ...
                    <div class="step-body">
                        ...
                        <input type="text" placeholder="Juzgado" id="txtJuzgadoConsultaRegistro"class="step-input">
...
<script src="resources/js/carpetainvestigacionadoles.js"/>
