...
<div id="frmRequisiciones" style="display: none">
    ...
    <div class="  form-group row btn-toolbar col-10">
        ...
        <button type="button" class="btn btn-primary btn-sm btn-space"
                id="enviarRequisicion">Enviar Reporte</button>
    ...
    <div class="form-group ">
        <label for="example-search-input" class="col-10 col-form-label">Servidor Publico que Reporta</label>
        <div class="col-10">
            <input class="form-control" type="text" value="" id="txtobservaciones">
        </div>
        <label for="example-search-input" class="col-10 col-form-label">Area que Reporta</label>
        <div class="col-10">
            <input class="form-control" type="text" value="" id="txtobservaciones">
        </div>
        <label for="example-search-input" class="col-10 col-form-label">Descripción del problema</label>
        <div class="col-10">
            <input class="form-control" type="text" value="" id="txtobservaciones">
        </div>
    </div>
...
<div id="ListaRequisiciones" style="display: block">
    ...
    <div class="  form-group row btn-toolbar col-10">
        <button type="button" class="btn btn-primary btn-sm btn-space"
                id="guardarRequisicion">Nuevo Reporte</button>
    </div>
    <div class="dropdown-divider"></div>
