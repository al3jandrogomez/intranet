...
<div id="frmRequisiciones" style="display: none">
	...
	<div class="form-group ">
		<label for="example-search-input" class="col-10 col-form-label">Descripción de avance</label>
		<div class="col-10">
        ...
        <div class="form-group ">
		<label for="example-search-input" class="col-10 col-form-label">Observaciones del reporte</label>
		<div class="col-10">
			<input class="form-control" type="text" value=""
				id="txtCantidadRequerida">
		</div>
