...
<div class="form-group row">
    <h1>Calificación de Reportes</h1>
...
<div id="frmRequisiciones" style="display: none">
    ...
    <div class="  form-group row btn-toolbar col-10">
        ...
        <button type="button" class="btn btn-primary btn-sm btn-space"
                id="enviarRequisicion">Enviar Calificación</button>
    ...
    <div class="form-group ">
       <label for="example-search-input" class="col-10 col-form-label">Calificación(1 mas baja, 5 mas alta)</label>
    ...
    <div class="form-group ">
       <label for="example-search-input" class="col-10 col-form-label">Atención por parte del personal de Informática</label>
       <select id="cmbListaEstatus" class="form-control"
                >
    ...
    <div class="form-group ">
        <label for="example-search-input" class="col-10 col-form-label">Comentario sobre la atención</label>
        <div>
