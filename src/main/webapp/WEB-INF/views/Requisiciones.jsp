...
<div class="form-group row">
	<h1>Requisicion para Almac&eacute;n</h1>
...
<div id="frmRequisiciones" style="display: none">
	...
	<div class="  form-group row btn-toolbar col-10">
		...
		<button type="button" class="btn btn-primary btn-sm btn-space"
			id="enviarRequisicion">Enviar Requisicion</button>
...
<div id="ListaRequisiciones" style="display: block">
	...
	<div class="  form-group row btn-toolbar col-10">
		<button type="button" class="btn btn-primary btn-sm btn-space"
			id="guardarRequisicion">Nueva Requisicion</button>
...
<script>
	...
	notificar = function() {
		...
		var options = {
			...
			body : "Este es le cuerpo de la notificacin",

			icon : "imgs/logoNotifs.png"

		};

		var notif = new Notification("Ejemplo de notificacin", options);
